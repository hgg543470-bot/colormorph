...
requirements = python3, flet, flet-core, flet-web, pillow, msgpack, repath, websockets, typing_extensions, httpx, httpcore, anyio, sniffio, certifi, idna, pydantic>=2.5.0, jinja2, markupsafe, fastapi, uvicorn, starlette, h11, exceptiongroup, annotated-types, typing-compat, annotated-doc
...
android.permissions = INTERNET, POST_NOTIFICATIONS, FOREGROUND_SERVICE, FOREGROUND_SERVICE_SPECIAL_USE, DATA_SYNC, FOREGROUND_SERVICE_MEDIA_PLAYBACK, MEDIA_PLAYBACK, SYSTEM_ALERT_WINDOW, WAKE_LOCK, RECEIVE_BOOT_COMPLETED, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, MANAGE_EXTERNAL_STORAGE, REQUEST_INSTALL_PACKAGES, moe.shizuku.privileged.api
