...
requirements = python3, flet, flet-core, flet-web, pillow, msgpack, repath, websockets, typing_extensions, httpx, httpcore, anyio, sniffio, certifi, idna, pydantic, jinja2, markupsafe, fastapi, uvicorn, starlette, h11, exceptiongroup, annotated-types, typing-compat
